...
namespace UNSORTED
{
	...
	static void _CREATE_EXPLOSION(Vector3* coords, const char* explosionName, Actor _owner, Vector3* damageVector, bool _Unk4) { Invoke<0xE7023D23, void>(coords, explosionName, _owner, damageVector, _Unk4); }
